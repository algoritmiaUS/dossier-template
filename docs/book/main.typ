...
#show: dossier.with(
  ...
  date: datetime.today(),
  num_cols:3,
  flipped:true // Indica si la orientación es vertical u horizontal
)
...
#let language = {
  let valid-values = ("python", "cpp")
  let value = sys.inputs.at("language", default: "cpp") // CAMBIAR LENGUAJE AQUÍ
                                                           // PARA VISUALIZACIÓN
